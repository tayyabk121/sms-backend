...
public class AcademicYearHelperImpl implements AcademicYearHelper {
     ...
     * an IdNotFoundException is thrown with a descriptive message.
     *
     * @param id the ID of the AcademicYear to find
     * @return the AcademicYear entity with the specified ID
     * @throws IdNotFoundException if no AcademicYear with
